...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8341982409:AAHkk2mEcleNuMH9_UidsOkQni-TtBVbfhw")
ADMIN_ID = int(os.environ.get("ADMIN_ID", "302182791"))
...
BET_TYPES = [
    "Выиграет в соревновании (1 место)",
    "Проиграет в соревновании (4 место)",
    "Займёт 1 место менее чем в 5 испытаниях",
    "Капитан команды выиграет конкурс капитанов",
]
